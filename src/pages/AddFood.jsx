    ...
    <div id="add-food-page" className="w-full h-screen bg-[#292929]">
      ...
      >
        ...
        >
          ...
          >
            <div>
              <h1 className="text-white text-3xl font-bold">Tambah Kuliner</h1>
            </div>
            <animated.img
              src={addKuliner}
              alt=""
          ...
          >
            ...
            <div id="add-photo" className="w-full h-[50%] bg-[#292929] rounded-[20px] flex flex-col justify-center items-center gap-2 cursor-pointer">
              {photo ? (
                <img
