      ...
      const getData = () => {
        ...
        instance
          ...
          .then((response) => {
            ...
            console.log(response.data.data.kuliner);
          })
          .catch((error) => {
            console.log(error);
          });
        ...
        {data && (
          <div
            ...
            >
              ...
              >
                <div id="detail-icon" className="w-full h-[15%] flex items-center justify-between px-[5%]">
                  <NavLink
                    to="/home"
                ...
                <div id="detail-img" className="w-full h-[20%] flex gap-6 justify-center items-center mb-[8%]">
                  <div
                    id="detail-sm-image"
              ...
              >
                <div id="detail-1" className="w-full h-[10%] flex flex-col">
                  <h1 id="detail-title" className="text-5xl text-[#f15e3c] font-bold">
                    {data.nama_kuliner}
                  </h1>
                  <h2 className="text-white text-xl">{data.daerah}</h2>
                </div>
                <div id="detail-2" className="w-full h-[80%]">
                  <h1 id="detail-2-h1" className="text-[#f15e3c] h-[6%] text-xl font-bold ">
                    Deskripsi :
                  </h1>
                ...
                <div id="detail-3" className="flex items-center justify-between w-full h-[10%]">
                  <p className="text-white">
                    Artikel ditulis oleh
                    <span className="text-[#f15e3c]"> {userName}</span>.
                  </p>
                  <AiFillLike
              ...
              {info ? (
                ...
                >
                  <div className="relative w-[300px] bg-[#292929] rounded-[20px] p-6 flex flex-col items-center">
                    ...
                    <h2 className="text-white text-xl mb-4">Info</h2>
                    <div className="flex flex-col gap-4">
                      <NavLink
                        to={`/update`}
                        className="bg-[#f15e3c] rounded-full flex justify-center items-center px-5 py-2"
                      >
                        <span className="text-white">Edit</span>
                      </NavLink>
                      <NavLink onClick={() => deleteData(data.id)} className="bg-[#f15e3c] rounded-full flex justify-center items-center px-5 py-2">
